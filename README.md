...
> **"계좌가 파란색일 때, 나의 팬심은 더 뜨거워지는가?"** > 본 프로젝트는 개인의 주식 포트폴리오 수익률과 엔믹스(NMIXX) 버블 DM 전송량 사이의 정서적 상관관계를 데이터로 입증합니다.

---

## 🧐 Motivation
급격한 시장 변동성 속에서 투자자는 심리적 위안을 찾기 마련입니다. 저는 주가가 폭락한 날 유독 엔믹스 버블 메시지를 많이 보낸다는 가설을 세웠고, 이를 증명하기 위해 1년간의 데이터를 분석했습니다.
...
## 🏆 Conclusion
데이터 분석 결과, 저에게 엔믹스는 단순한 연예인을 넘어 **주식 시장의 하락장에서 멘탈을 잡아주는 '정서적 안전자산'**임이 입증되었습니다. 
